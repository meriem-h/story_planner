...
export default function ModalWedding() {
    ...
    const handleClick = async (e) => {
        ...
        const result = await api('book:create', {
            book: book,
        })
            ...
            <section>
                <article className='border border-2 border-orange-100 bg-orange-100 rounded-lg m-4 p-4'>
                    ...
                    <form className="max-w-sm mx-auto flex flex-col gap-4">
                        ...
                        <div>
                            {/* <button onClick={handleClick('S1')} className='border rounded rounded-lg px-4 py-2  bg-fuchsia-300 text-white'>valider</button> */}
                        </div>
