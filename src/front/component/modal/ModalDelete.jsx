        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-lg p-6 shadow-xl z-10 w-[400px]">
                <div className='flex flex-col items-center gap-4'>
                    ...
                    <p className='text-center text-orange-800 font-bold'>{message || 'Êtes-vous sûr de vouloir supprimer ?'}</p>
                    <p className='text-center text-orange-400 text-sm'>Cette action est irréversible !</p>
                    <div className='flex gap-3 w-full'>
                        <button onClick={onClose} className='flex-1 py-2 border border-orange-200 rounded-lg text-orange-400 hover:bg-orange-50 transition-colors'>
                            Annuler
                        </button>
