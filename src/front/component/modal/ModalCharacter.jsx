            ...
            <div className='p-4 flex flex-col gap-4 h-full'>
                ...
                <div className='flex justify-center'>
                    <div className='w-16 h-16 rounded-full bg-primary-300 flex items-center justify-center text-white text-2xl font-bold overflow-hidden'>
                        {character.image_url
                            ? <img onClick={() => setPreviewSrc(character.image_url)} src={character.image_url} alt='aperçu' className='w-full h-full object-cover' onError={(e) => e.target.style.display = 'none'} />
